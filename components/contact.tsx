...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    window.location.href = `mailto:razaasaleemm@gmail.com?subject=${subject}&body=${body}`
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a
                    href="mailto:razaasaleemm@gmail.com"
                    className="text-gray-300 hover:text-purple-400 transition-colors"
                  >
                    razaasaleemm@gmail.com
                  </a>
                </div>
              </div>
            ...
            <div className="mt-12">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-gray-800 hover:bg-purple-700 transition-colors p-3 rounded-full">
            ...
            <form onSubmit={handleSubmit} className="bg-gray-800 rounded-xl p-8 shadow-lg">
              ...
              {submitSuccess && (
                <div className="mb-6 p-4 bg-green-900/30 border border-green-500 rounded-lg text-green-400">
                  Your email client has been opened with the message details. Thank you for reaching out!
                </div>
              )}
